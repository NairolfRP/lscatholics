...
const _toast = ToastPrimitive.createToastManager()

const toast = Object.assign(_toast, {
  success: (title: React.ReactNode) => _toast.add({ title, type: 'success' }),
  error: (title: React.ReactNode) => _toast.add({ title, type: 'error' }),
  info: (title: React.ReactNode) => _toast.add({ title, type: 'info' }),
  warning: (title: React.ReactNode) => _toast.add({ title, type: 'warning' }),
  loading: (title: React.ReactNode) => _toast.add({ title, type: 'loading' }),
})
