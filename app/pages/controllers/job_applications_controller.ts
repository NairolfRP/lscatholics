...
import { createEmploymentApplicationValidator } from '#pages/validators/employment_application'
import { DiscordWebhookService } from '#discord/services/discord_webhook_service'
import env from '#start/env'
import { DiscordEmbedField } from '#discord/interfaces/entities/discord_embed'
...
export default class JobApplicationsController {
  ...
  async index({ params, inertia }: HttpContext) {
    ...
    return inertia.render('jobs/application', { job: job.toJSON(), isExpired })
  }
