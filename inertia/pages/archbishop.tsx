...
export default function ArchbishopPage() {
  return (
    <>
      ...
      <div className="py-20">
        <Container as="section" className="flex flex-col gap-15">
          <Typography variant="h2" className="border-none font-bold text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            ...
            <div className="flex-1 text-justify">
              <Typography>
                ...
                2025 par le pape François. Né le 26 janvier 1960 à Worcester dans le Massachusetts,
                il est le deuxième enfant de l'union de Seamus (1936-2005) et Bridget (1938-2015)
                Callahan, une famille irlandais-américaine immigrée dans l'est des États-Unis depuis
                le 19e siècle.
              </Typography>
              <Typography>
              ...
              <Typography>
                ...
                Bernard Law. En 2011, le pape Benoit XVI le nomme évêque de Bridport (Connecticut),
                puis en 2018, le pape François le transfert en Ohio comme Archevêque de Cincinnati.
              </Typography>
              <Typography>
                Lors du consistoire du 29 juin 2018, Sa Sainteté le Pape François le créé cardinal.
                A Rome, il est actuellement membre du Dicastère pour l'Évangélisation et du
          ...
          <div className="text-justify">
            ...
            <img
              ...
              className="md:float-right max-h-90 md:max-h-70 mx-auto md:ml-8 md:mb-2"
              loading="lazy"
            />
            <div>
              <Typography>
              ...
              <Typography className="[&:not(:first-child)]:mt-4 mb-6">
              ...
              <Typography variant="list" className="my-0">
                ...
                <li>
                  ...
                  d'argent et un aigle de gueules. Ces armoiries personnelles expriment l'identité
                  du Cardinal : la harpe souligne son héritage irlandais, le croissant d'argent
                  rappelle l'Immaculée Conception, patronne des États-Unis, et l'aigle rouge
                  symbolise les origines américaines de sa famille dans l'Est du pays.
                </li>
              </Typography>

              <Typography>
                Les ornements qui entourent l'écu sont ceux réservés aux cardinaux de la Sainte
                Église romaine :
              </Typography>
              <Typography variant="list" className="my-0">
                <li>
                  le <strong>chapeau galero de gueules</strong>, orné de quinze houppes de chaque
                  côté ;
                </li>
                <li>
