<template>
  <ServiceLayout serviceId="mediation">
    <Typography>
      ...
      que ce soit les <strong>conflits internationaux entre États</strong> à travers ses importants
      réseaux diplomatiques ou que ce soit <strong>local</strong> par l'action des évêques et des
