<template>
  <ServiceLayout serviceId="benediction">
    <Typography>
      ...
      maisons, les lieux de travail, les commerces, les outils de travail, les véhicules et tout ce
      qui entoure les lieux, les instruments ou les objets qui entourent les activités humaines.
    </Typography>
    ...
    <Typography variant="h2" class="mt-10"> Conditions pour les bénédictions </Typography>
    <Typography variant="list">
      <li>Non obligatoire, mais il est recommandé d'être baptisé ou en parcours vers le baptême</li>
    ...
    <Typography variant="h2" class="mt-10"> Demander des bénédictions</Typography>
    <Typography>
