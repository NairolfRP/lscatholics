  ...
  <DashboardLayout>
    ...
    <div class="space-y-6">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-3xl font-bold tracking-tight">Modifier l'événement</h1>
              ...
              <CardContent class="space-y-4">
                <div class="grid gap-4 md:grid-cols-2">
                  <div class="space-y-2">
                    ...
                    <DateTimePicker id="startDate" v-model="form.startDate" />
...
const form = useForm({
  ...
  parishId: props.event.parishId || undefined,
