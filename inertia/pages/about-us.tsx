    ...
    <>
      ...
      >
        <div className="relative z-10">
          <Typography
            variant="h2"
            className="text-inherit border-none text-5xl md:text-6xl font-bold mb-6"
          >
            <span className="text-gradient">Nous Sommes</span>
            <br />
            Une Famille de Familles
          </Typography>
          <Typography className="text-inherit text-xl md:text-2xl opacity-90 leading-relaxed">
      ...
      <section
        className="relative py-20 bg-gray-50 bg-cover bg-center h-auto text-white"
        style={{ backgroundImage: `url(${VolunteerImage})` }}
      >
        <div className="absolute inset-0 bg-black/60" />
        <Container size="content" className="relative z-10 space-y-5">
          <Typography
            variant="h2"
      ...
      <Container size="wide" className="py-15">
        <div className="text-center mb-16">
          <Typography
            variant="h2"
            className="border-none text-5xl font-bold text-primary mb-6 font-serif"
          >
            Notre Histoire
          </Typography>
          <div className="w-24 h-1 bg-catholic-gold mx-auto cross-divider mb-8" />
        ...
        <div className="text-justify space-y-4">
          ...
          <Typography>
            ...
            Santos (« Le Village de Notre-Dame, la Reine des Saints »). Si La Placita est la
            première église bâtie à Los Santos, la mission San Gabriel, érigée en 1771, fut la
            première église de notre Archidiocèse, avant même à la naissance de notre pays. Cette
            mission abrita le récemment canonisé saint Junìpero Serra, un missionnaire franciscain
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="relative block w-auto max-w-xl">
              <img
                src={StJuniperoImage}
                alt="St. Junìpero Serra, San Andreas Catholic Missions Founder"
                className="w-full h-auto object-cover overflow-hidden rounded-lg shadow-2xl transition-transform duration-300 hover:scale-[1.02]"
                loading="lazy"
              />
            </div>
          </div>
